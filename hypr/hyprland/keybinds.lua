...
-- Programs
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(apps.music))
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(apps.browser))
hl.bind(mainMod .. " + ALT + B", hl.dsp.exec_cmd(apps.browserAlt))
hl.bind(mainMod .. " + D", hl.dsp.exec_cmd(apps.emojiPick))
hl.bind(mainMod .. " + E", hl.dsp.exec_cmd(apps.fileManager))
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.exec_cmd(apps.editor))
hl.bind(mainMod .. " + G", hl.dsp.exec_cmd(apps.github))
hl.bind(mainMod .. " + H", hl.dsp.exec_cmd("hyprpicker -a"))
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd(apps.terminal .. " nmtui", {float = true}))
hl.bind(mainMod .. " + O", hl.dsp.exec_cmd(script .. "/scrcpy.sh"))
hl.bind(mainMod .. " + Q", hl.dsp.exec_cmd(apps.terminal))
hl.bind(mainMod .. " + ALT + Q", hl.dsp.exec_cmd(apps.terminalAlt))
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.exec_cmd(apps.terminal, {float = true}))
hl.bind(mainMod .. " + S", hl.dsp.exec_cmd("uuctl"))
hl.bind(mainMod .. " + T", hl.dsp.exec_cmd(apps.telegram))
hl.bind(mainMod .. " + ALT + T", hl.dsp.exec_cmd(apps.chatgpt))
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("clipman pick -t rofi"))
hl.bind(mainMod .. " + Y", hl.dsp.exec_cmd(apps.youtube))
...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(apps.menu .. " drun"))
